...
class AgendaFilterTests(APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email='teste@user.com', password='foo')
        self.anon_user = User.objects.create_user(email='teste2@user.com', password='bar')
        ...
        self.doctorA = DoctorFactory.create(specialty=SpecialtyFactory.create(name='Geral'))
        self.doctorB = DoctorFactory.create(specialty=SpecialtyFactory.create(name='Pediatria'))
        self.doctorC = DoctorFactory.create(specialty=SpecialtyFactory.create(name='Oftalmologista'))
    ...
    def test_filter(self):
        ...
        start_date = Faker().date_between(start_date='+23d', end_date='+23d')
