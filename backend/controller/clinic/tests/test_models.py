...
class SpecialtyModelTestCase(TestCase):
    ...
    def test_create_specialty(self):
        specialty = Specialty.objects.create(name='Geral')
        self.assertEqual(specialty.name, 'Geral')
        self.assertEqual(str(specialty), 'Geral')


class DoctorModelTestCase(TestCase):

    def setUp(self):
        self.specialty = Specialty.objects.create(name='Geral')
